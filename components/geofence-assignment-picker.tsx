...
export function GeofenceAssignmentPicker({ geofenceId, initialAssignments, contacts, users, farms, experiments }: Props) {
  ...
  async function handleAdd() {
    ...
    try {
      ...
      const res = await fetch(`/api/geofences/${geofenceId}/assignments`, {
        method: "POST",
  ...
  async function handleRemove(assignmentId: number) {
    ...
    try {
      const res = await fetch(`/api/geofences/${geofenceId}/assignments/${assignmentId}`, { method: "DELETE" });
